...
<html class="no-js" lang="es"><head>
    ...
    <link rel="stylesheet" type="text/css" href="Los%20Gamers%20Comunidad_files/style.css">
    <script type="text/javascript" src="Los%20Gamers%20Comunidad_files/jquery-2.js"></script>
    <script type="text/javascript" src="Los%20Gamers%20Comunidad_files/funciones.js"></script>
    <style type="text/css">.fb_hidden{position:absolute;top:-10000px;z-index:10001}.fb_invisible{display:none}.fb_reset{background:none;border:0;border-spacing:0;color:#000;cursor:auto;direction:ltr;font-family:"lucida grande", tahoma, verdana, arial, sans-serif;font-size:11px;font-style:normal;font-variant:normal;font-weight:normal;letter-spacing:normal;line-height:1;margin:0;overflow:visible;padding:0;text-align:left;text-decoration:none;text-indent:0;text-shadow:none;text-transform:none;visibility:visible;white-space:normal;word-spacing:normal}.fb_reset>div{overflow:hidden}.fb_link img{border:none}
        ...
        .fb_iframe_widget{display:inline-block;position:relative}.fb_iframe_widget span{display:inline-block;position:relative;text-align:justify}.fb_iframe_widget iframe{position:absolute}.fb_iframe_widget_fluid_desktop,.fb_iframe_widget_fluid_desktop span,.fb_iframe_widget_fluid_desktop iframe{max-width:100%}.fb_iframe_widget_fluid_desktop iframe{min-width:220px;position:relative}.fb_iframe_widget_lift{z-index:1}.fb_hide_iframes iframe{position:relative;left:-10000px}.fb_iframe_widget_loader{position:relative;display:inline-block}.fb_iframe_widget_fluid{display:inline}.fb_iframe_widget_fluid span{width:100%}.fb_iframe_widget_loader iframe{min-height:32px;z-index:2;zoom:1}.fb_iframe_widget_loader .FB_Loader{background:url(http://z-1-static.xx.fbcdn.net/rsrc.php/v2/y9/r/jKEcVPZFk-2.gif) no-repeat;height:32px;width:32px;margin-left:-16px;position:absolute;left:50%;z-index:4}</style></head>
<body>
<div class="container">
    <h3 style="margin: 5px 0px 0px;">¿YA ERES MIEMBRO?</h3>
    <section class="tabs">
        <input id="tab-1" name="radio-set" class="tab-selector-1" checked="checked" type="radio">
        <label for="tab-1" class="tab-label-1">INGRESAR</label>
        ...
        <div class="content"> <!--height: 250px; -->
            <div class="content-1 login-content">
                ...
                <form style="display: none;" id="login-from-rest" method="POST" action="login_proc.php" autocomplete="off">
            ...
            <div class="content-2">
                <div id="regist-conten" class="regist-alquiler-conten">
                    <form id="regist-form" method="POST" action="registrar_proc.php" autocomplete="off">
            ...
            <div id="login-msjresp" class="msj-notif">
                <img src="Los%20Gamers%20Comunidad_files/ajax-loader.GIF" style="margin-top:50px;">
            </div>
        </div>
