...
if (isset($_POST['form'])) {
    ...
    $nombre   = $_POST['regist_nomb'];
    $apellido = $_POST['regist_apel'];
    $email    = $_POST['regist_email'];
    $clave    = $_POST['regist_pass'];
    ...
    VALUES
    (9,1,'$nombre','$apellido','$email','".md5(_COOKIE_KEY_.$clave)."',NOW(),NULL,0,NULL,NULL,0,'"._COOKIE_KEY_."',NULL,1,0,0,NOW(),NOW())")){
